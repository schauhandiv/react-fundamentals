...
- Learned how to use Babel to complie jsx to js in browser (by including babel script)
    - browser does not evaluate script inside script type='text/babel', instead babel evaluates it
- className and children are keyword properties of a React element, and "div {...props}" jsx syntax worked magically
- the order of properties inside an object matter; the later one overwrites the earlier if it is duplicated. 
    - Watch the Spread props video at 1:30 min
- Object.assign() order of objects inside matters
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=schauhan%40divsionsinc.com).
