...
- This excercise was a hard one to follow. I didn't quiet get what they wanted. 
  - Then realized that the arg to my message function shd have been {children} instead of just children!!! gaaaah!
  - *(After watching the video I get it now!)*
- Some weird ways to create Elements!!
  - pass func as first arg to React.createElement
  - No idea why extra credit 1 is working (first arg is message func without it's arg being passed, how is it working?)
- prop.Types for validation of element props in development mode only (does not get run in production mode for performance reasons)
- React.Fragment to group elements without a rendering a DOM node
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=schauhan%40divsionsinc.com).
