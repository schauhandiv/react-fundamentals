...
- This was an easy exercise
  - But the way KCD does it in the video is better. My way only took care of just the style and className props, if Box passed in additional props doing it my way lose these props. But doing it KCD's way will get those props applied to the Box too, so watch the video.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=schauhan%40divsionsinc.com).
