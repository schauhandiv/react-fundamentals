...
- Use unpkg CDN to use React, ReactDOM library/API without having to npm install them
- x - I don't really get the 'children' prop in React.createElement!!
- Excellent article on 4 ways of passing children to React.createElement: https://frontarm.com/james-k-nelson/4-ways-pass-children-react-elements/
- React exposes a UMD = Universal Module Defn which allows us to create global variable in the browser
- React library is the core library to create React elements
- Then use different libraries to render these elements on different platforms. For eg.
    - ReactDOM to render on a web page
    - react-native to render on mobile
    - react-vr for VR apps
- Keep 'unique key' error for elements in an array in React
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=schauhan%40divsionsinc.com).
