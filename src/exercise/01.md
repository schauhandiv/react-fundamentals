...
- Use body.append(element) to append a html element to body
- Use document.createElement(element) to create new html element
- Use element.append(element) to append to element
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=schauhan%40divsionsinc.com).
